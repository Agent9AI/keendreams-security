/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: 5607aa80d1d33a915d11925447743061)
// Runtime types generated with workerd@1.20260915.1 2026-09-01 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	OAUTH_KV: KVNamespace;
	VECTORS: VectorizeIndex;
	AI: Ai;
	CLIENT_MEMORY: DurableObjectNamespace<import("./worker").ClientMemory>;
	REGISTRY: DurableObjectNamespace<import("./worker").Registry>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "ClientMemory" | "Registry";
	}
